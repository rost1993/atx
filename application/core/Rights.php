...
class Rights {
	...
	private static $rules_page_for_role = [
		...
		'9' => ['', 'logout', 'car', 'car_search', 'driver', 'driver_search', 'repair', 'repair_search', 'dtp', 'dtp_search', 'adm', 'adm_search', 'car_document', 'contacts', 'edit', 'edit_directory', 'admin_panel', 'notice_events'],
	];
