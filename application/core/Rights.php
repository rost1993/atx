...
class Rights {
	...
	private static $rules_page_for_role = [
		'0' => ['', 'login'],
		'1' => ['', 'logout', 'car', 'car_search', 'driver', 'driver_search', 'repair', 'repair_search', 'dtp', 'dtp_search', 'adm', 'adm_search', 'car_document', 'edit', 'edit_directory', 'admin_panel', 'notice_events', 'cranvu', 'vu', 'car_document', 'car_for_driver', 'accessories', 'wheel', 'speedometer', 'osago', 'pts', 'certificate_registration', 'drivers_dopog', 'cars_dopog', 'technical_inspection', 'tractor_vu', 'calibration'],
		'2' => ['', 'logout', 'car', 'car_search', 'driver', 'driver_search', 'repair', 'repair_search', 'dtp', 'dtp_search', 'adm', 'adm_search', 'car_document', 'edit', 'edit_directory', 'admin_panel', 'notice_events', 'cranvu', 'vu', 'car_document', 'car_for_driver', 'accessories', 'wheel', 'speedometer', 'osago', 'pts', 'certificate_registration', 'drivers_dopog', 'cars_dopog', 'technical_inspection', 'tractor_vu', 'calibration'],
