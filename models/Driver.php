...
class Driver extends Model {
	...
	protected $sql_get_record = "SELECT {table}.id, {table}.fam, {table}.imj, {table}.otch, {table}.dt_rojd, {table}.mob_phone, {table}.slugba, {table}.kodrai, {table}.ibd_arx, {table}.dostup, b.doc_s, b.doc_n, "
			...
			. " e.doc_s as doc_s_boat, e.doc_n as doc_n_boat, DATE_FORMAT(e.doc_date, '%d.%m.%Y') as doc_date_boat, DATE_FORMAT(e.doc_end_date, '%d.%m.%Y') as doc_end_date_boat, "
			. " e.c_gydro, e.c_moto, e.c_cater, e.c_parus_12, e.c_parus_22, e.c_parus_60, e.c_parus_more_60, e.path_to_file as file_vu_boat, e.file_extension as ext_file_vu_boat,"
			...
			. " LEFT JOIN drivers_document_boat e ON {table}.id = e.id_driver AND e.ibd_arx=1 "
